...
/**
 * Data source for the Package view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class PackageDataSource extends DataSource<PackageList> {
  data: PackageList[] = EXAMPLE_DATA;
  ...
  private getSortedData(data: PackageList[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'packageBemerkungen': return compare(a.packageBemerkungen, b.packageBemerkungen, isAsc);
        case 'packageTitel': return compare(+a.packageTitel, +b.packageTitel, isAsc);
        default: return 0;
      }
    });
  }
